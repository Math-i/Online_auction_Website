...
//   const firstname = "Mathi"
//   useEffect(() => {
//     axios.get(`http://localhost:8080/getauct/${firstname}`)
//     .then(response => {
        ...
        <div className="departments">
          <div className="departmentcontainer">
            {data.map((image, index) => (
              <Link to ="/biddingdisplay"><div key={index} className="grid-item">
                
                 <img src={image.img} width={'200px'} height={'200px'} alt={image.text}  />
